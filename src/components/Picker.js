 ...
 * @param root0.customItemValueDelimiter
 * @param root0.clearSearchFieldOnSelect
...
function Picker({
  ...
  const getBadgeColor = useCallback(
    (str, index) => _badgeColors[index % _badgeColors.length],
    [_badgeColors],
  );
  ...
  const getBadgeDotColor = useCallback(
    (str, index) => _badgeDotColors[index % _badgeDotColors.length],
    [_badgeDotColors],
  );
